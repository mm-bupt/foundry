...
from var_app.agent.factory import create_agent
...
from var_app.session.compaction import is_overflow, prune as compaction_prune, do_compaction
...
async def stream_chat(
    ...
    try:
        ...
        if (
            ...
            from var_app.chat.title import generate_title
