...
from var_app.model.registry import get_model_info, get_provider_prefix
from var_app.agent.deps import AgentDeps
from var_app.agent.system_prompt import build_system_prompt
from var_app.session.compaction import trim_and_summarize
...
def _register_tools(agent: Agent):
    from var_app.agent.tools import register_file_tools, register_search_tools, register_skill_tools
    from var_app.agent.subagent_tools import register_task_tools
    from var_app.agent.todo_tools import register_todo_tools
    from var_app.agent.question_tools import register_question_tools
